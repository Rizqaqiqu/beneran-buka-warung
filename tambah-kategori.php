...
if (isset($_POST['submit'])) {
    ...
    if ($nama === '') {
        ...
        $insert = mysqli_query($conn, "INSERT INTO tb_category (category_name) VALUES ('{$nama_db}')");
        if ($insert) {
...
<title>Tambah Kategori — WarungRizqi</title>
  ...
  <div class="card" role="main" aria-labelledby="title">
    <div class="header">
      <div style="display:flex;gap:12px;align-items:center">
        ...
        <div>
          <div id="title" class="title">Tambah Kategori</div>
          <div class="sub">Tambahkan kategori baru untuk produk</div>
        </div>
      </div>
      <div>
    ...
    <form class="form" method="POST" action="">
      <input type="text" name="nama" class="input-control" placeholder="Nama Kategori" required autofocus>
